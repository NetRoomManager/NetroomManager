						...
						<table class="table table-borderless">
							...
							<tr>
								...
								<td>
									...
									<input class="form-control" type="text" id="editTicketName" name="name" placeholder="이용권 이름 등록" required aria-label="default input example">
								</td>
							</tr>
							<tr>
								<th>이용권시간</th>
								<td>
									<input class="form-control" type="number" id="editTicketTime" name="time" placeholder="분" required aria-label="default input example">
								</td>
							</tr>
							<tr>
								<th>이용권가격</th>
								<td>
									<input class="form-control" type="number" id="editTicketPrice" name="price" placeholder="금액입력" required aria-label="default input example">
								</td>
							</tr>
							</tbody>
						</table>
	...
	<table class="table table-hover">
		...
		<c:forEach var="ticket" items="${ticketList}" >
			<tr class="text-center">
				...
				<td><button type="button" id="editBtn" class="btn btn-outline-warning"
							...
							>수정</button></td>
				<td><button type="button" id="deleteTicketBtn" class="btn btn-outline-danger"
