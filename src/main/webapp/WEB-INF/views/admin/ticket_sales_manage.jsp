    ...
    <table class="table table-hover">
        ...
        <c:forEach var="dto" items="${list}">
            <tr class="text-center">
                ...
                <td class="pt-3">${dto.paymentMethod}</td>
                <td class="pt-3">${dto.ticketName}</td>
                <td class="pt-3">${dto.orderTotalPrice}원</td>
                <td class="pt-3">${dto.salesDate}</td>
                <td class="pt-3">${dto.username}</td>
                <td class="pt-3">${dto.paymentId}</td>
                <td>
                    <button type="button" class="btn btn-outline-danger" >환불</button>
                </td>
            </tr>
        </c:forEach>
        </tbody>
