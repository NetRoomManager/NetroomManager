                    ...
                    <div class="row g-0">
                        ...
                        <div class="col-9">
                            ...
                            <div class="card-footer bg-transparent">
                                <div class="d-flex justify-content-between">
                                    <p style="font-size: 1.5rem; font-weight: bold;">8,800<span
                                            style="font-size: 0.9rem; font-weight: 500;">(카카오페이)</span></p>
                                    <div>
                                        <button type="button" class="btn btn-outline-warning" data-bs-toggle="button">
                                            준비중
                                        </button>
